...
public class ZoomVerificationActivity extends ZoomCaliVeriActivity {
    private final static String TAG = "ZoomVerificationActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        zoom_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ZoomVerificationActivity.this,CameraWTVerificationActivity.class);
